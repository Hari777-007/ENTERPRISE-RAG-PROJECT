...
def run(rows: list[dict]) -> list[dict]:
    ...
    ## CONVERTING INTO LIST OF DICT BECAUSE THE PANDAS DATARAME (IT IS A IN MEMORY COMPLEX PYTHON OBJECT
    # CANNOT BE SERIALIZED INTO JASON FORMAT),
    # DOES NOT COMPATIBLE WITH HTTP DATA communication FORMAT
