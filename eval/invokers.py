...
class Invoker(ABC):# this is just a oops design pattern to use common invoker schema to all type of invoker
...
class ServiceInvoker(Invoker):
    ...
    def invoke(
        ...
        if intent not in self.SUPPORTED_INTENTS: # filtering of goldens
